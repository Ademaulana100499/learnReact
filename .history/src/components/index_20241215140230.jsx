    ...
    <div className="p-4 text-white bg-blue-600">
      <div className="container flex items-center justify-between mx-auto">
        ...
        <div className="space-x-6">
          {token ? (
            <button
              className="w-full px-4 py-2 font-semibold text-white bg-blue-500 rounded-lg shadow hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-1"
